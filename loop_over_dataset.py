...
#configs_det = det.load_configs(model_name='fpn_resnet')#'darknet') # options are 'darknet', 'fpn_resnet'
...
exec_data = ['pcl_from_rangeimage', 'load_image']#['pcl_from_rangeimage']
# exec_detection = ['bev_from_pcl', 'detect_objects']#['bev_from_pcl']
...
# exec_visualization = ['show_objects_in_bev_labels_in_camera']#[] #['show_range_image']# ['show_pcl'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
# exec_data = []
# exec_data = ['pcl_from_rangeimage']#['pcl_from_rangeimage']
#exec_detection = ['bev_from_pcl', 'detect_objects']
#exec_detection = ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance']#['bev_from_pcl']
exec_detection = ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
exec_tracking = [] # options are 'perform_tracking'
#exec_visualization = ['show_objects_in_bev_labels_in_camera']#['show_pcl']
exec_visualization = ['show_detection_performance']#[] #['show_range_image']# ['show_pcl'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
